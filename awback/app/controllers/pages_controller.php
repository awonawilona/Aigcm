 ...
 */
    ...
    var $components = array('Noticias', 'Archivos', 'Perfil');
    ...
    {        
        ...
        $noticias = $this->Noticias->getNoticias();
        
        $this->set('u_noticias', $noticias);
        
        $archivos = $this->Archivos->getArchivos();
        
        $this->set('u_archivos', $archivos);
